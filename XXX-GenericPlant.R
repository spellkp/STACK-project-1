...
file.rename("SETUP.CFG", "NO_SETUP.CFG")     #This file is not used for Model A.
...
for(q in 1:12) {
  ...
  for (j in 1:MonthMatrix[q,3]) {
    ...
    StartLocInfo1 <- c(39.28682, -96.1172, 200, 340000) #Starting Location #1 Parameters (lat, lon, height(AGL), emission rate(mass/h), area(m^2), heat(W))
    ...
    PolRat <- 340000                  #Emission rate (mass/hr)
    PolDur <- 24                      #Pollutant duration (hr)
    RelStart <- c(12, q, j, 00, 00)   #Pollutant start (YY, MM, DD, HH, MM)
    
    CenterLatLon <- c(StartLocInfo1[1], StartLocInfo1[2])       #Center the display grid (lat, lon)
...
file.rename("NO_SETUP.CFG", "SETUP.CFG")     #This file IS NOW REQUIRED!
...
ModelType <- "B"      #A - EPA data used (only), B - 0m Stack Height, C - 0m/s Emissions, D - 0m^2 area, E - Full Model
...
for(q in 1:12) {
  ...
  for (j in 1:MonthMatrix[q,3]) {
    ...
    NumOfStartLocs <- 1           #Number of starting locations
    StartLocInfo1 <- c(39.28682, -96.1172, 0, 340000, 75, 10000000) #Starting Location #1 Parameters (lat, lon, height(AGL), emission rate(mass/h), area(m^2), heat(W))
...
ModelType <- "C"      #A - EPA data used (only), B - 0m Stack Height, C - 0m/s Emissions, D - 0m^2 area, E - Full Model
...
NumOfStartLocs <- 1           #Number of starting locations
StartLocInfo1 <- c(39.28682, -96.1172, 200, 340000, 0, 10000000) #Starting Location #1 Parameters (lat, lon, height(AGL), emission rate(mass/h), area(m^2), heat(W))
...
ModelType <- "D"      #A - EPA data used (only), B - 0m Stack Height, C - 0m/s Emissions, D - 0m^2 area, E - Full Model
...
for(q in 1:12) {
  ...
  for (j in 1:MonthMatrix[q,3]) {
    ...
    NumOfStartLocs <- 1           #Number of starting locations
    StartLocInfo1 <- c(39.28682, -96.1172, 200, 340000, 75, 0) #Starting Location #1 Parameters (lat, lon, height(AGL), emission rate(mass/h), area(m^2), heat(W))
...
for(q in 1:12) {
  ...
  for (j in 1:MonthMatrix[q,3]) {
    ...
    NumOfStartLocs <- 1           #Number of starting locations
    StartLocInfo1 <- c(39.28682, -96.1172, 200, 340000, 75, 10000000) #Starting Location #1 Parameters (lat, lon, height(AGL), emission rate(mass/h), area(m^2), heat(W))
