...
StartLocInfo1 <- c(36.99781, -84.59239, 0, 147264.5, 23.64, 2396931.6) #Starting Location #1 Parameters (lat, lon, height(AGL), emission rate(mass/h), area(m^2), heat(W))
#StartLocInfo2 <- c(39.28681, -96.11721, 0, 557748.97, 47.17, 16788214.8) #Starting Location #2 Parameters (lat, lon, height(AGL), emission rate(mass/h), area(m^2), heat(W))
