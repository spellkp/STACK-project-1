...
StartLocInfo1 <- c(36.99781, -84.59239, 0, 146459.75, 23.64, 2396931.6) #Starting Location #1 Parameters (lat, lon, height(AGL), emission rate(mass/h), area(m^2), heat(W))
...
PolRat <- 147264.5                #Emission rate (mass/hr)
...
for(q in 1:12) {
  ...
  for (j in 1:MonthMatrix[q,3]) {
    ...
    NumOfStartLocs <- 1           #Number of starting locations
    StartLocInfo1 <- c(36.99781, -84.59239, 243.84, 146459.75, 0, 2396931.6) #Starting Location #1 Parameters (lat, lon, height(AGL), emission rate(mass/h), area(m^2), heat(W))
    #StartLocInfo2 <- c(46.75513, -122.85810, 143.3, 234563, 64.52, 3192486.16) #Starting Location #2 Parameters (lat, lon, height(AGL), emission rate(mass/h), area(m^2), heat(W))
    #StartLocInfo3 <- c(39.28681, -96.11618, 174.96, 568829.78, 47.17, 16591050.0) #Starting Location #3 Parameters (lat, lon, height(AGL), emission rate(mass/h), area(m^2), heat(W))
...
for(q in 1:12) {
  ...
  for (j in 1:MonthMatrix[q,3]) {
    ...
    NumOfStartLocs <- 1           #Number of starting locations
    StartLocInfo1 <- c(36.99781, -84.59239, 243.84, 146459.75, 23.64, 0) #Starting Location #1 Parameters (lat, lon, height(AGL), emission rate(mass/h), area(m^2), heat(W))
    #StartLocInfo2 <- c(46.75513, -122.85810, 143.3, 234563, 64.52, 3192486.16) #Starting Location #2 Parameters (lat, lon, height(AGL), emission rate(mass/h), area(m^2), heat(W))
    #StartLocInfo3 <- c(39.28681, -96.11618, 174.96, 568829.78, 47.17, 16591050.0) #Starting Location #3 Parameters (lat, lon, height(AGL), emission rate(mass/h), area(m^2), heat(W))
