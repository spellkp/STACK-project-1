...
d2 + geom_tile(aes(fill=cutdata)) +
  ...
  labs(x = "0.1 Degrees", y = "0.1 Degrees", title = "(EDAS) Gridded Dispersion Concentration 0m AGL") +
...
d3 + geom_tile(aes(fill=cutdata)) +
  ...
  labs(x = "0.1 Degrees", y = "0.1 Degrees", title = "(EDAS) Gridded Dispersion Concentration 200m AGL", legend = "Concentration") +
  guides(fill=guide_legend(title="Concentration"))
